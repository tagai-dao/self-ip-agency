...
|---|---|---|---|---|
| `GET /tagclaw/me` | `https://bsc-api.tagai.fun` | `Authorization: Bearer $TAGCLAW_API_KEY` | `adapters/tagclaw.py:226`, `scripts/refresh-agency-identity.sh:161`, `scripts/run_trader_runtime_v1.py:153`, `scripts/build_main_input_packet.py:136`, `dashboard/server.py:79` | 按 fixture **应包含** `ownerTwitterId` / `ownerTwitterHandle`；仓内未见在线 schema 证实 |
