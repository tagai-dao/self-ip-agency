...
- **v1 vs v2 scripts**: `run_main_runtime_v2.py`, `compute_tas_social_v2.py`, `build_main_input_packet_v2.py`, `runtime_utils_v2.py`, `wiki_lint_v1.py`, `select_strategy_v1.py` are current. Files without a version suffix (`wiki_lint.py`, `select_strategy.py`) are legacy — don't extend them.
